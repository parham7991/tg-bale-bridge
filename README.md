...
[![Tests](https://img.shields.io/badge/tests-126%20✅-success)](tests/)
...
| 🧪 **۱۲۶ تست آفلاین** | pytest شامل تست‌های واحد و سرتاسری — CI روی پایتون ۳.۱۰ تا ۳.۱۲ |
...
make test     # اجرای ۱۲۶ تست آفلاین (بدون نیاز به اکانت واقعی)
make lint     # ruff
```
