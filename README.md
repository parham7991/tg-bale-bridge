...
[![Tests](https://img.shields.io/badge/tests-93%20✅-success)](tests/)
...
| 🧪 **۹۳ تست آفلاین** | pytest شامل تست‌های واحد و سرتاسری — CI روی پایتون ۳.۱۰ تا ۳.۱۲ |
...
| `BALE_MODE` | – | `bot` (پیش‌فرض) یا `user` = سلف‌بات بله با حساب کاربری خودتان |
...
make test     # اجرای ۹۳ تست آفلاین (بدون نیاز به اکانت واقعی)
make lint     # ruff
```
